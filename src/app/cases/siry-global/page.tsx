  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <Section         
        dark
        title="Tecnologia" 
        content={['Para alcançar esses objetivos, utilizamos tecnologias de ponta no desenvolvimento do site. O novo site institucional e o hot site do Evolution foram construídos com as mais recentes ferramentas de web development e web design.', 'Implementamos técnicas de UI/UX para garantir uma experiência de usuário atraente e intuitiva. Além disso, incorporamos elementos de SEO para melhorar a visibilidade nos motores de busca e integração com redes sociais para uma presença online ampliada.']}
      />
      <Section         
        title="Soluções" 
